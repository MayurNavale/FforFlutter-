...
import 'dart:io';
import 'dart:convert';
import 'package:fortesttrial/pdfviver.dart';
...
NiceButton(
  width: MediaQuery.of(context).size.width,
    ...
    onPressed: () {
        ...
        //  Expanded(flex:5,child: InkWell( child:Container(color: Colors.lightBlue[200],
        //    child: Center(child:Text("Flight Crew Licence",style:TextStyle( fontSize: 35,fontStyle: FontStyle.italic))),),onTap: (){
        //    Navigator.push(  context, MaterialPageRoute(builder: (context) => PDFScreenLicence(pathOfPDFLicence,filepathLicence)),  ); },)),
         
        //  Expanded(flex: 5,child: Container(color: Colors.blue[200],
        //    child: Center(child: InkWell(child:Text("Flight Crew Licence"),onTap: (){
        //    Navigator.push(  context, MaterialPageRoute(builder: (context) => PDFScreenLicence(pathOfPDFLicence,filepathLicence), ), );   },),),)),
        //  Expanded(flex:5,child: InkWell( child:Container(color: Colors.lightBlue[400],
        //    child: Center(child:Text("Medical",style:TextStyle( fontSize: 35,fontStyle: FontStyle.italic))),),onTap: (){
        //    Navigator.push(  context, MaterialPageRoute(builder: (context) => PDFScreenLicence(pathOfPDFMedical,filepathMedica)),  ); },)),
         ]
     );
...
//////////////////
    ...
    reportdata.userId='a92a3003-68fc-4a3a-8ad5-cadf450dbccf';
   reportdata.languageCode='481';
 String json = welcomeToJson(reportdata);
 print( json);
  var url = 'http://192.168.43.246:8080/dLicence/api/exportReportDataForType';
