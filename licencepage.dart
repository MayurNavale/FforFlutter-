...
//   }
  ...
  builder: (FormFieldState<String> state) {
    return InputDecorator(
      ...
      isEmpty:  saveLicenseData.issuedBy == '',
      child: new DropdownButtonHideUnderline(
        child: new DropdownButton<String>(
          value:  saveLicenseData.issuedBy,
          isDense: true,
          onChanged: (String newValue) {
            setState(() {
              contries= newValue;
               saveLicenseData.issuedBy = newValue;
              state.didChange(newValue);
  ...
  builder: (FormFieldState<String> state) {
    return InputDecorator(
      ...
      isEmpty:  saveLicenseData.codeId == '',
      child: new DropdownButtonHideUnderline(
        child: new DropdownButton<String>(
          value:  saveLicenseData.codeId,
          isDense: true,
          onChanged: (String newValue) {
            setState(() {
            //  licenceCodeOptions= newValue;
               saveLicenseData.codeId = newValue;
              state.didChange(newValue);
